...
var chartfilt
 $(document).ready(function(){
	...
	var url = '/grower/chart2_detail/?year='+ year.join(",") + "&farmname=" + farm_name.join(",") + "&fieldname="+ field_name.join(",")+ "&statename=" + state_name.join(",")  + "&growername="+ growername + "&savings=" + savings;
...
var update_grower_detail = function() {
    ...
    url = '/grower/dashboard2/?growername='+ growername;
