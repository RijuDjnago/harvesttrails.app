...
urlpatterns = [
    ...
    path('traceability_report_all_csv_download_for_shipment_id/<str:search_text>/<int:crop_id>/<int:diversion_id>/<str:from_date>/<str:to_date>/',views.export_all_csv_for_shipmentID, name="export_all_csv_for_shipmentID"),
    ...
    path('view_trace/<str:search_text>/<int:crop_id>/<int:diversion_id>/<str:from_date>/<str:to_date>/', views.trace_shipment, name="view_trace"),
