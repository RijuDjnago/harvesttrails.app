...
admin.site.register(ProcessorShipmentDiversionTracking)
admin.site.register(WarehouseShipmentDiversionTracking)
admin.site.register(ItemSpecification)
admin.site.register(Carriers)
admin.site.register(ProcessorShipmentDiversionReminder)
admin.site.register(WarehouseShipmentDiversionReminder)
